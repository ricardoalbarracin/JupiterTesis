var UpdateStudent = function () {
	...
	return {
		...
		onFinish_Begin: function (jqXHR, settings) {
            ...
            var isValidSections = Utils.isValidSections(UpdateStudent.facade, sectionsToValidate);
			if (!isValidSections) {
				return false;
			}

			// Salida
            var dataSections = Utils.getDataSections(UpdateStudent.facade, sectionsToValidate);

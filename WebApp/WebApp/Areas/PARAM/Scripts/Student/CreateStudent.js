var CreateStudent = function () {
	...
	return {
		...
		onFinish_Begin: function (jqXHR, settings) {
            ...
            var isValidSections = Utils.isValidSections(CreateStudent.facade, sectionsToValidate);
			if (!isValidSections) {
				return false;
			}

			// Salida
            var dataSections = Utils.getDataSections(CreateStudent.facade, sectionsToValidate);
